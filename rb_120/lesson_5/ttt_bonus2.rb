...
class Board
  attr_reader :human_marker, :computer_marker
...
class TTTGame
  ...
  def initialize
    clear
    @human = Player.new(ask_human_name, ask_human_marker)
    @computer = Player.new(COMPUTER_NAMES.sample, choose_computer_marker)
